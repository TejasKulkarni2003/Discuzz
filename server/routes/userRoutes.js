...
// update route
router.route("/user/updateuser/:id").put(isLogged, updateUser);

// login route
router.route("/user/login").post(loginUser);

//logout
router.route("/user/logout").get(isLogged, logout);

//Change Password
router.route("/user/changepassword").post(isLogged, changePassword)
